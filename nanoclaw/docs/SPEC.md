...
|---------|---------|--------|
| `@nano [message]` | `@Andy what's the weather?` | Talk to Claude |

### Commands Available in Main Channel Only

| Command | Example | Effect |
|---------|---------|--------|
| `@nano add group "Name"` | `@Andy add group "Family Chat"` | Register a new group |
| `@nano remove group "Name"` | `@Andy remove group "Work Team"` | Unregister a group |
| `@nano list groups` | `@Andy list groups` | Show registered groups |
| `@nano remember [fact]` | `@Andy remember I prefer dark mode` | Add to global memory |
