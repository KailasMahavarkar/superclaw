...
Replace `@nano` with your configured trigger name (`ASSISTANT_NAME` in `.env`):

```
@nano post a tweet: Hello world!

@nano like this tweet https://x.com/user/status/123

@nano reply to https://x.com/user/status/123 with: Great post!

@nano retweet https://x.com/user/status/123

@nano quote https://x.com/user/status/123 with comment: Interesting
```
